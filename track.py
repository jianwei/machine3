...
def run(
    ...
    print("----------strongsort_list:",strongsort_list,len(strongsort_list))
    ...
    for frame_idx, (path, im, im0s, vid_cap, s) in enumerate(dataset):
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            print("---------------i------------------",i)
            # import json
            # print("prev_frames:",prev_frames)
            if cfg.STRONGSORT.ECC:  # camera motion compensation
               
                # print("prev_frames[i]:",prev_frames[i])
                # print("curr_frames[i]:",curr_frames[i])
            ...
            if det is not None and len(det):
                ...
                t4 = time_sync()
                # print("xywhs.cpu()",xywhs,type(xywhs),xywhs.cpu(),type(xywhs.cpu()))
...
def parse_opt():
    ...
    # parser.add_argument('--yolo-weights', nargs='+', type=str, default='./yolov5/yolov5s.engine', help='model.pt path(s)')
    parser.add_argument('--strong-sort-weights', type=str, default=WEIGHTS / 'osnet_x0_25_msmt17.pt')
    # parser.add_argument('--strong-sort-weights', type=str, default=WEIGHTS / 'deepsort.engine')
    ...
    parser.add_argument('--capture_device',default=0, type=str, help='capture_device camera number')
